...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Kaoutar Sadik, a full stack engineer building thoughtful software with React, Spring Boot, and Node.js." },
      { name: "author", content: "Kaoutar Sadik" },
